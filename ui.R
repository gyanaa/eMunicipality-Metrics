...
navbarPage(
  ...
  tabPanel(
    ...
    div(
      ...
      #Gyana_tochange#  valueBoxOutput("tab1_valuebox_total_cities", width = 6),
      #Gyana_tochange# valueBoxOutput("tab1_valuebox_total_population", width = 6),
      #Gyana_tochange#valueBoxOutput("tab1_valuebox_male_pop_perc", width = 6),
      #Gyana_tochange#valueBoxOutput("tab1_valuebox_female_pop_perc", width = 6),
      #Gyana_tochange#valueBoxOutput("tab1_valuebox_literacy_rate", width = 6),
      #Gyana_tochange#valueBoxOutput("tab1_valuebox_sex_ratio", width = 6),
...
fluidRow(
  ...
  column(highchartOutput("tab2_bubble_map", height = "600px"),
         width = 6),
